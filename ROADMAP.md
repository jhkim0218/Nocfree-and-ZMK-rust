...
| Rust left ANSI | 150,016 | `0x27000..0x394FF` |
...
| P0 regression / P2 diagnostics done | Split reconnect | Right reconnects at normal desk distance without moving the halves closer | Stage logs now identify scan/RSSI/connect/security/GATT/disconnect; hardware captured an MTU-exchange failure followed by success at roughly 30 cm | P3 changes one radio/retry variable at a time until repeated desk-distance cycles pass |
