...
| Supported | Rust USB dongle / 2.4G | Left sends merged reports to one universal USB receiver | Encrypted BLE service, dedicated bonds, fixed maximum-size reports, disconnect release, and USB HID pass software checks. The universal image passed ANSI hardware tests, including reconnect after idle. Factory ESB/nRF24/numpad are out of scope | ISO/JIS/KR matching keyboard pairs pass pairing, reconnect, input ordering, latency, recovery, and coexistence |
