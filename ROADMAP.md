...
| Experimental | Rust USB dongle | Left sends merged reports to a layout-matched USB receiver | Encrypted BLE service, dedicated bonds, absolute sequenced reports, disconnect release, USB HID, and bounded KR dongle UF2 pass software checks; factory ESB/nRF24/numpad are out of scope | Matching KR trio passes pairing, reconnect, input ordering, latency, recovery, and coexistence on hardware |
