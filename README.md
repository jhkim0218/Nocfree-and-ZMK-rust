...
| KR | Supported firmware; universal Rust dongle UF2 available | Hardware mapping tested with hyun's help; full Rust firmware validation still requires matching hardware |
