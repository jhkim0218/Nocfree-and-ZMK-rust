...
| P0 회귀 / P3.3 설정 | split 재연결 | 반쪽을 가까이 옮기지 않고 일반 책상 거리에서 오른쪽 재연결 | P3.2에서 6.1/17.2초 입력 복귀. 저장소 오른쪽은 +8 dBm이지만 실기·전력 미검증이고 미배포 | +8 dBm 실기 비교는 나중에 하고 사용자 지시에 따라 지금 P4 진행 |
