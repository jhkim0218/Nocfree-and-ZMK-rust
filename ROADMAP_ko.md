...
| Rust 왼쪽 ANSI | 150,016 | `0x27000..0x394FF` |
...
| P0 회귀 / P2 진단 완료 | split 재연결 | 반쪽을 가까이 옮기지 않고 일반 책상 거리에서 오른쪽 재연결 | scan/RSSI/connect/security/GATT/disconnect 단계 로그를 추가했고 약 30cm 실기에서 MTU 교환 실패 뒤 다음 시도 성공을 포착 | P3에서 radio/retry 변수를 하나씩 바꿔 책상 거리 반복 재연결 통과 |
