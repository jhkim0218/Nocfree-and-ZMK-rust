...
| Rust 오른쪽 ANSI | 94,208 | `0x27000..0x327FF` |
...
| P0 회귀 / P3.2 완료 | split 재연결 | 반쪽을 가까이 옮기지 않고 일반 책상 거리에서 오른쪽 재연결 | 표준 MTU와 250/500/1,000 ms 단계별·키 입력 광고로 책상 거리 2회가 6.1/17.2초에 입력 복귀. -85 dBm 보안 timeout 1회 남음 | latency는 유지하고 같은 거리에서 오른쪽 TX 출력을 비교한 뒤 책상 거리 반복 |
