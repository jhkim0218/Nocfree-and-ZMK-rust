...
| Experimental | Rust USB dongle / 2.4G | 暗号化 BLE、専用 bond、固定最大サイズ report、切断 release、USB HID は software 検査合格。共通 image は ANSI 実機確認済み。純正 ESB/nRF24/numpad は対象外 | ISO/JIS/KR の対応 keyboard pair で pairing・再接続・順序・latency・復旧・共存を確認する |
