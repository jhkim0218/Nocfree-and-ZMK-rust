    ...
    let struct_fields = match &mut struc.fields {
        ...
        _ => {
            ...
            ctxt.error_spanned_by(
                s,
                "gatt_service structs must have named fields, not tuples.",
            );
