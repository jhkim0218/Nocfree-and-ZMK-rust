...
- [x] G1: dongle framing, advertisement matching, sequence handling, output routing, and dedicated bond records pass for every layout
  ...
  EVIDENCE: exit=0; shell=C:\WINDOWS\system32\cmd.exe; cwd=D:\study\nocfree\NocFree-and-rust; path=186adcb2655b/36 entries; output=Finished `test` profile [optimized + debuginfo] target(s) in 0.29s | Running unittests src\lib.rs (target\x86_64-pc-windows-msvc\debug\deps\nocfree_and_rust-895f109436db97e1.exe)
...
- [x] G2: every layout's left, right, and dongle ARM applications compile without warnings
  ...
  EVIDENCE: exit=0; shell=C:\WINDOWS\system32\cmd.exe; cwd=D:\study\nocfree\NocFree-and-rust; path=186adcb2655b/36 entries; output=Finished `release` profile [optimized] target(s) in 0.08s | Finished `release` profile [optimized] target(s) in 0.09s
...
- [x] G3: every layout-matched dongle UF2 is regenerated from the ARM application and stays inside the application partition
  ...
  EVIDENCE: exit=0; shell=C:\WINDOWS\system32\cmd.exe; cwd=D:\study\nocfree\NocFree-and-rust; path=186adcb2655b/36 entries; output=Ran 5 tests in 0.012s | OK
...
- [x] G4: repository artifact, documentation, and recovery contracts pass
  ...
  EVIDENCE: exit=0; shell=C:\WINDOWS\system32\cmd.exe; cwd=D:\study\nocfree\NocFree-and-rust; path=186adcb2655b/36 entries; output=Ran 34 tests in 0.019s | OK
