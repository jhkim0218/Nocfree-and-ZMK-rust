...
pub const LAYOUT_ID: u8 = 1;
pub const LAYOUT_NAME: &str = "ANSI";
pub const PRODUCT_NAME: &str = "NocFree & ANSI";
...
pub const ROW_KEY_COUNTS: [usize; 6] = [15, 15, 14, 14, 14, 12];
...
pub const VISUAL_TO_RAW: [usize; KEY_COUNT] = [
    ...
    32, 33, 34, 35, 36, 77, 78, 79, 80, 81, 82, 83,
];
...
pub const fn base_action(raw: usize) -> Action {
    ...
    panic!("raw key index outside the ANSI map")
}
