...
pub const LAYOUT_ID: u8 = 2;
pub const LAYOUT_NAME: &str = "ISO";
pub const PRODUCT_NAME: &str = "NocFree & ISO";
pub const LEFT_KEY_COUNT: usize = 38;
pub const RIGHT_KEY_COUNT: usize = 47;
pub const KEY_COUNT: usize = LEFT_KEY_COUNT + RIGHT_KEY_COUNT;
pub const LEFT_FN_RAW: usize = 33;
pub const RIGHT_FN_RAW: usize = 80;
pub const EXPANDER_ADDRESSES: [u8; 3] = [0x20, 0x22, 0x24];
pub const LEFT_ROW_COUNTS: [u8; 6] = [7, 7, 6, 6, 7, 5];
pub const RIGHT_ROW_COUNTS: [u8; 6] = [8, 8, 8, 8, 8, 7];
pub const EXTRA_LEFT_KEYS: usize = 0;
pub const EXTRA_RIGHT_KEYS: usize = 0;
pub const ROW_KEY_COUNTS: [usize; 6] = [15, 15, 14, 14, 15, 12];
...
const VISUAL_BASE: [Action; KEY_COUNT] = [
    ...
    k!(0x1c), k!(0x18), k!(0x0c), k!(0x12), k!(0x13), k!(0x2f), k!(0x30), k!(0x4e),

    k!(0x39), k!(0x04), k!(0x16), k!(0x07), k!(0x09), k!(0x0a),
    k!(0x0b), k!(0x0d), k!(0x0e), k!(0x0f), k!(0x33), k!(0x34), k!(0x32), k!(0x28),

    k!(0xe1), k!(0x64), k!(0x1d), k!(0x1b), k!(0x06), k!(0x19), k!(0x05),
    k!(0x11), k!(0x10), k!(0x36), k!(0x37), k!(0x38), k!(0xe5), k!(0x52), k!(0x4c),
...
pub const VISUAL_TO_RAW: [usize; KEY_COUNT] = [
    0, 1, 2, 3, 4, 5, 6, 38, 39, 40, 41, 42, 43, 44, 45,
    7, 8, 9, 10, 11, 12, 13, 46, 47, 48, 49, 50, 51, 52, 53,
    14, 15, 16, 17, 18, 19, 54, 55, 56, 57, 58, 59, 60, 61,
    20, 21, 22, 23, 24, 25, 62, 63, 64, 65, 66, 67, 68, 69,
    26, 27, 28, 29, 30, 31, 32, 70, 71, 72, 73, 74, 75, 76, 77,
    33, 34, 35, 36, 37, 78, 79, 80, 81, 82, 83, 84,
];
...
pub const fn base_action(raw: usize) -> Action {
    ...
    panic!("raw key index outside the ISO map")
}
